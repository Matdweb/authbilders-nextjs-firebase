...
export default function App() {
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl pt-32 pb-8">
        <div className="text-left">
          <h1 className="font-semibold tracking-tight text-balance text-gray-100 text-5xl">Reset your Password</h1>
          <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">Hello Matias, <br/>Click on the button below to be redirected</p>
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">Don't share this with anyone 🤫, <br/>Thank you</p>
        </div>
      </div>
      <div className="mb-8 flex justify-center">
          <div className="font-semibold text-blue-400 flex items-center gap-x-1">
